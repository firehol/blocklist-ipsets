...
blocklist_de|Blocklist.de IPs that have attacked their honeypots in the last 48 hours|ipv4 hash:ip|27191 unique IPs|30 mins |[source](http://lists.blocklist.de/lists/all.txt?r=16990)
bogons|Team-Cymru.org: private and reserved addresses defined by RFC 1918, RFC 5735, and RFC 6598 and netblocks that have not been allocated to a regional internet registry|ipv4 hash:net|13 entries, 592708608 unique IPs|1 day |[source](http://www.team-cymru.org/Services/Bogons/bogon-bn-agg.txt?r=4131)
...
ciarmy|CIArmy.com IPs with poor Rogue Packet score that have not yet been identified as malicious by the InfoSec community|ipv4 hash:ip|417|3 hours |[source](http://cinsscore.com/list/ci-badguys.txt?r=7886)
...
compromised|EmergingThreats.net distribution of IPs that have beed compromised (at the time of writing includes openbl, bruteforceblocker and sidreporter)|ipv4 hash:ip|2698|12 hours |[source](http://rules.emergingthreats.net/blockrules/compromised-ips.txt?r=14710)
danmetor|dan.me.uk dynamic list of TOR exit points|ipv4 hash:ip|6360 unique IPs|30 mins |[source](https://www.dan.me.uk/torlist/?r=32214)
dshield|DShield.org top 20 attacking networks|ipv4 hash:net|20 entries (5120 unique IPs)|4 hours |[source](http://feeds.dshield.org/block.txt?r=12634)
emerging_block|EmergingThreats.net default blacklist (at the time of writing includes spamhaus DROP and dshield)|ipv4 hash:net|921 entries (17934867 unique IPs)|12 hours |[source](http://rules.emergingthreats.net/fwrules/emerging-Block-IPs.txt?r=5264)
...
**fullbogons**|Team-Cymru.org: IP space that has been allocated to an RIR, but not assigned by that RIR to an actual ISP or other end-user|ipv4 **hash:net**|3616 entries, 671231704 unique IPs|1 day |[source](http://www.team-cymru.org/Services/Bogons/fullbogons-ipv4.txt?r=16038)
...
ib_bluetack_hijacked|iBlocklist.com free version of BlueTack.co.uk hijacked IP-Blocks Hijacked IP space are IP blocks that are being used without permission|ipv4 hash:net|535 entries (9177856 unique IPs)|12 hours |[source](http://list.iblocklist.com/?list=usrcshglbiilevmyfhse&fileformat=p2p&archiveformat=gz)
ib_bluetack_level1|iBlocklist.com free version of BlueTack.co.uk Level 1 (for use in p2p)|ipv4 hash:net|215693 entries (765044590 unique IPs)|12 hours |[source](http://list.iblocklist.com/?list=ydxerpxkpcfqjaybcssw&fileformat=p2p&archiveformat=gz)
ib_bluetack_level2|iBlocklist.com free version of BlueTack.co.uk Level 2 (for use in p2p)|ipv4 hash:net|75927 entries (348729520 unique IPs)|12 hours |[source](http://list.iblocklist.com/?list=gyisgnzbhppbvsphucsw&fileformat=p2p&archiveformat=gz)
ib_bluetack_level3|iBlocklist.com free version of BlueTack.co.uk Level 3 (for use in p2p)|ipv4 hash:net|18550 entries (139108857 unique IPs)|12 hours |[source](http://list.iblocklist.com/?list=uwnukjqktoggdknzrhgh&fileformat=p2p&archiveformat=gz)
...
ib_bluetack_spyware|iBlocklist.com free version of BlueTack.co.uk known malicious SPYWARE and ADWARE IP Address ranges|ipv4 hash:net|898 entries (336971 unique IPs)|12 hours |[source](http://list.iblocklist.com/?list=llvtlsjyoyiczbkjsxpf&fileformat=p2p&archiveformat=gz)
...
openbl|OpenBL.org default blacklist (currently it is the same with 90 days)|ipv4 hash:ip|9889|4 hours |[source](http://www.openbl.org/lists/base.txt.gz?r=11539)
openbl_1d|OpenBL.org last 24 hours IPs|ipv4 hash:ip|416|4 hours |[source](http://www.openbl.org/lists/base_1days.txt.gz?r=9885)
openbl_30d|OpenBL.org last 30 days IPs|ipv4 hash:ip|5195|4 hours |[source](http://www.openbl.org/lists/base_30days.txt.gz?r=15723)
...
palevo|Abuse.ch Palevo worm includes IPs which are being used as botnet C&C for the Palevo crimeware|ipv4 hash:ip|13 unique IPs|30 mins |[source](https://palevotracker.abuse.ch/blocklists.php?download=ipblocklist&r=14832)
...
spamhaus_drop|Spamhaus.org DROP list (according to their site this list should be dropped at tier-1 ISPs globaly)|ipv4 hash:net|636 entries (18060288 unique IPs)|12 hours |[source](http://www.spamhaus.org/drop/drop.txt?r=7964)
spamhaus_edrop|Spamhaus.org EDROP (should be used with DROP)|ipv4 hash:net|54 entries (419840 unique IPs)|12 hours |[source](http://www.spamhaus.org/drop/edrop.txt?r=10705)
stop_forum_spam_1h|StopForumSpam.com last 24 hours IPs used by forum spammers|ipv4 hash:ip|5570|1 hour |[source](http://www.stopforumspam.com/downloads/listed_ip_1.zip)
...
tor_servers|torstatus.blutmagie.de list of all TOR network servers|ipv4 hash:ip|6423|30 mins |[source](https://torstatus.blutmagie.de/ip_list_all.php/Tor_ip_list_ALL.csv?r=28876)
