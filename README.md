...
blocklist_de|Blocklist.de IPs that have attacked their honeypots in the last 48 hours|ipv4 hash:ip|26800 unique IPs|30 mins |[src](http://lists.blocklist.de/lists/all.txt?r=11545)
...
ciarmy|CIArmy.com IPs with poor Rogue Packet score that have not yet been identified as malicious by the InfoSec community|ipv4 hash:ip|417 unique IPs|3 hours |[src](http://cinsscore.com/list/ci-badguys.txt?r=20935)
...
danmetor|dan.me.uk dynamic list of TOR exit points|ipv4 hash:ip|6346 unique IPs|30 mins |[src](https://www.dan.me.uk/torlist/?r=28859)
...
openbl|OpenBL.org default blacklist (currently it is the same with 90 days)|ipv4 hash:ip|9889 unique IPs|4 hours |[src](http://www.openbl.org/lists/base.txt.gz?r=1802)
openbl_1d|OpenBL.org last 24 hours IPs|ipv4 hash:ip|416 unique IPs|4 hours |[src](http://www.openbl.org/lists/base_1days.txt.gz?r=15690)
openbl_30d|OpenBL.org last 30 days IPs|ipv4 hash:ip|5195 unique IPs|4 hours |[src](http://www.openbl.org/lists/base_30days.txt.gz?r=17209)
openbl_60d|OpenBL.org last 60 days IPs|ipv4 hash:ip|7798 unique IPs|4 hours |[src](http://www.openbl.org/lists/base_60days.txt.gz?r=22220)
openbl_7d|OpenBL.org last 7 days IPs|ipv4 hash:ip|1059 unique IPs|4 hours |[src](http://www.openbl.org/lists/base_7days.txt.gz?r=20466)
openbl_90d|OpenBL.org last 90 days IPs|ipv4 hash:ip|9889 unique IPs|4 hours |[src](http://www.openbl.org/lists/base_90days.txt.gz?r=6053)
palevo|Abuse.ch Palevo worm includes IPs which are being used as botnet C&C for the Palevo crimeware|ipv4 hash:ip|13 unique IPs|30 mins |[src](https://palevotracker.abuse.ch/blocklists.php?download=ipblocklist&r=7902)
...
stop_forum_spam_1h|StopForumSpam.com last 24 hours IPs used by forum spammers|ipv4 hash:ip|5621 unique IPs|1 hour |[src](http://www.stopforumspam.com/downloads/listed_ip_1.zip)
