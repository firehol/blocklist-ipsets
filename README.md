...
bogons|Team-Cymru.org: private and reserved addresses defined by RFC 1918, RFC 5735, and RFC 6598 and netblocks that have not been allocated to a regional internet registry|ipv4 hash:net|13 (592708608 IPs)|1 day |[source](http://www.team-cymru.org/Services/Bogons/bogon-bn-agg.txt?r=8192)
...
dshield|DShield.org top 20 attacking networks|ipv4 hash:net|20 (5120 IPs)|4 hours |[source](http://feeds.dshield.org/block.txt?r=28527)
emerging_block|EmergingThreats.net default blacklist (at the time of writing includes spamhaus DROP and dshield)|ipv4 hash:net|921 (17934867 IPs)|12 hours |[source](http://rules.emergingthreats.net/fwrules/emerging-Block-IPs.txt?r=32458)
...
fullbogons|Team-Cymru.org: IP space that has been allocated to an RIR, but not assigned by that RIR to an actual ISP or other end-user|ipv4 hash:net|3616 (671231704 IPs)|1 day |[source](http://www.team-cymru.org/Services/Bogons/fullbogons-ipv4.txt?r=6116)
...
ib_bluetack_hijacked|iBlocklist.com free version of BlueTack.co.uk hijacked IP-Blocks Hijacked IP space are IP blocks that are being used without permission|ipv4 hash:net|535 (9177856 IPs)|12 hours |[source](http://list.iblocklist.com/?list=usrcshglbiilevmyfhse&fileformat=p2p&archiveformat=gz)
ib_bluetack_level1|iBlocklist.com free version of BlueTack.co.uk Level 1 (for use in p2p)|ipv4 hash:net|215693 (765044590 IPs)|12 hours |[source](http://list.iblocklist.com/?list=ydxerpxkpcfqjaybcssw&fileformat=p2p&archiveformat=gz)
ib_bluetack_level2|iBlocklist.com free version of BlueTack.co.uk Level 2 (for use in p2p)|ipv4 hash:net|75927 (348729520 IPs)|12 hours |[source](http://list.iblocklist.com/?list=gyisgnzbhppbvsphucsw&fileformat=p2p&archiveformat=gz)
ib_bluetack_level3|iBlocklist.com free version of BlueTack.co.uk Level 3 (for use in p2p)|ipv4 hash:net|18550 (139108857 IPs)|12 hours |[source](http://list.iblocklist.com/?list=uwnukjqktoggdknzrhgh&fileformat=p2p&archiveformat=gz)
...
ib_bluetack_spyware|iBlocklist.com free version of BlueTack.co.uk known malicious SPYWARE and ADWARE IP Address ranges|ipv4 hash:net|898 (336971 IPs)|12 hours |[source](http://list.iblocklist.com/?list=llvtlsjyoyiczbkjsxpf&fileformat=p2p&archiveformat=gz)
...
spamhaus_drop|Spamhaus.org DROP list (according to their site this list should be dropped at tier-1 ISPs globaly)|ipv4 hash:net|636 (18060288 IPs)|12 hours |[source](http://www.spamhaus.org/drop/drop.txt?r=13876)
spamhaus_edrop|Spamhaus.org EDROP (should be used with DROP)|ipv4 hash:net|54 (419840 IPs)|12 hours |[source](http://www.spamhaus.org/drop/edrop.txt?r=20277)
