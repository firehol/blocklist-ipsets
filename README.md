...
**fullbogons**|Team-Cymru.org: IP space that has been allocated to an RIR, but not assigned by that RIR to an actual ISP or other end-user|ipv4 **hash:net**|3616 entries, 671231704 unique IPs|1 day |[src](http://www.team-cymru.org/Services/Bogons/fullbogons-ipv4.txt?r=3657)
