...
blocklist_de|Blocklist.de IPs that have attacked their honeypots in the last 48 hours|ipv4 hash:ip|26126 unique IPs|30 mins |[src](http://lists.blocklist.de/lists/all.txt?r=8218)
...
palevo|Abuse.ch Palevo worm includes IPs which are being used as botnet C&C for the Palevo crimeware|ipv4 hash:ip|12 unique IPs|30 mins |[src](https://palevotracker.abuse.ch/blocklists.php?download=ipblocklist&r=698)
...
zeus|Abuse.ch Zeus Tracker default blocklist including hijacked sites and web hosting providers|ipv4 hash:ip|262 unique IPs|30 mins |[src](https://zeustracker.abuse.ch/blocklist.php?download=ipblocklist&r=23308)
