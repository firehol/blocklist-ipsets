...
danmetor|dan.me.uk dynamic list of TOR exit points|ipv4 hash:ip|6402 unique IPs|30 mins |[src](https://www.dan.me.uk/torlist/?r=19492)
...
openbl|OpenBL.org default blacklist (currently it is the same with 90 days)|ipv4 hash:ip|9884 unique IPs|4 hours |[src](http://www.openbl.org/lists/base.txt.gz?r=1590)
openbl_1d|OpenBL.org last 24 hours IPs|ipv4 hash:ip|408 unique IPs|4 hours |[src](http://www.openbl.org/lists/base_1days.txt.gz?r=29806)
openbl_30d|OpenBL.org last 30 days IPs|ipv4 hash:ip|5111 unique IPs|4 hours |[src](http://www.openbl.org/lists/base_30days.txt.gz?r=14406)
openbl_60d|OpenBL.org last 60 days IPs|ipv4 hash:ip|7793 unique IPs|4 hours |[src](http://www.openbl.org/lists/base_60days.txt.gz?r=5983)
openbl_7d|OpenBL.org last 7 days IPs|ipv4 hash:ip|1057 unique IPs|4 hours |[src](http://www.openbl.org/lists/base_7days.txt.gz?r=25531)
openbl_90d|OpenBL.org last 90 days IPs|ipv4 hash:ip|9884 unique IPs|4 hours |[src](http://www.openbl.org/lists/base_90days.txt.gz?r=30559)
palevo|Abuse.ch Palevo worm includes IPs which are being used as botnet C&C for the Palevo crimeware|ipv4 hash:ip|13 unique IPs|30 mins |[src](https://palevotracker.abuse.ch/blocklists.php?download=ipblocklist&r=23323)
rosi_connect_proxies|rosinstrument.com open CONNECT proxies distributed via its RSS feed and aggregated for the last 7 days|ipv4 hash:ip|408 unique IPs|2 hours |[src](http://tools.rosinstrument.com/proxy/plab100.xml?r=7134)
rosi_web_proxies|rosinstrument.com open HTTP proxies distributed via its RSS feed and aggregated for the last 7 days|ipv4 hash:ip|568 unique IPs|2 hours |[src](http://tools.rosinstrument.com/proxy/l100.xml?r=26923)
...
stop_forum_spam_1h|StopForumSpam.com last 24 hours IPs used by forum spammers|ipv4 hash:ip|5590 unique IPs|1 hour |[src](http://www.stopforumspam.com/downloads/listed_ip_1.zip)
...
tor_servers|torstatus.blutmagie.de list of all TOR network servers|ipv4 hash:ip|6380 unique IPs|30 mins |[src](https://torstatus.blutmagie.de/ip_list_all.php/Tor_ip_list_ALL.csv?r=22840)
