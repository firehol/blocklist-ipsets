...
:--:|:--:|:--:|:-----:|:--:|:---:|
alienvault_reputation|AlienVault.com IP reputation database|ipv4 hash:ip|199869 unique IPs|12 hours |[src](https://reputation.alienvault.com/reputation.generic?r=437)
autoshun|AutoShun.org IPs identified as hostile by correlating logs from distributed snort installations running the autoshun plugin|ipv4 hash:ip|853 unique IPs|4 hours |[src](http://www.autoshun.org/files/shunlist.csv?r=25068)
blocklist_de|Blocklist.de IPs that have attacked their honeypots in the last 48 hours|ipv4 hash:ip|25516 unique IPs|30 mins |[src](http://lists.blocklist.de/lists/all.txt?r=17098)
...
bruteforceblocker|danger.rulez.sk IPs detected by bruteforceblocker (fail2ban alternative for SSH on OpenBSD)|ipv4 hash:ip|2693 unique IPs|3 hours |[src](http://danger.rulez.sk/projects/bruteforceblocker/blist.php?r=6366)
ciarmy|CIArmy.com IPs with poor Rogue Packet score that have not yet been identified as malicious by the InfoSec community|ipv4 hash:ip|432 unique IPs|3 hours |[src](http://cinsscore.com/list/ci-badguys.txt?r=31758)
...
danmetor|dan.me.uk dynamic list of TOR exit points|ipv4 hash:ip|6473 unique IPs|30 mins |[src](https://www.dan.me.uk/torlist/?r=6806)
dshield|DShield.org top 20 attacking networks|ipv4 hash:net|19 entries, 5120 unique IPs|4 hours |[src](http://feeds.dshield.org/block.txt?r=27476)
...
feodo|Abuse.ch Feodo trojan includes IPs which are being used by Feodo (also known as Cridex or Bugat) which commits ebanking fraud|ipv4 hash:ip|36 unique IPs|30 mins |[src](https://feodotracker.abuse.ch/blocklist/?download=ipblocklist&r=13886)
fullbogons|Team-Cymru.org: IP space that has been allocated to an RIR, but not assigned by that RIR to an actual ISP or other end-user|ipv4 hash:net|3618 entries, 671229912 unique IPs|1 day |[src](http://www.team-cymru.org/Services/Bogons/fullbogons-ipv4.txt?r=27559)
...
malc0de|Malc0de.com malicious IPs of the last 30 days|ipv4 hash:ip|407 unique IPs|1 day |[src](http://malc0de.com/bl/IP_Blacklist.txt?r=12893)
...
openbl|OpenBL.org default blacklist (currently it is the same with 90 days)|ipv4 hash:ip|9874 unique IPs|4 hours |[src](http://www.openbl.org/lists/base.txt.gz?r=5892)
openbl_1d|OpenBL.org last 24 hours IPs|ipv4 hash:ip|383 unique IPs|4 hours |[src](http://www.openbl.org/lists/base_1days.txt.gz?r=6519)
openbl_30d|OpenBL.org last 30 days IPs|ipv4 hash:ip|5079 unique IPs|4 hours |[src](http://www.openbl.org/lists/base_30days.txt.gz?r=6370)
...
stop_forum_spam_1h|StopForumSpam.com last 24 hours IPs used by forum spammers|ipv4 hash:ip|5558 unique IPs|1 hour |[src](http://www.stopforumspam.com/downloads/listed_ip_1.zip)
...
stop_forum_spam_7d|StopForumSpam.com last 7 days IPs used by forum spammers|ipv4 hash:ip|27726 unique IPs|1 day |[src](http://www.stopforumspam.com/downloads/listed_ip_7.zip)
...
tor_servers|torstatus.blutmagie.de list of all TOR network servers|ipv4 hash:ip|6449 unique IPs|30 mins |[src](https://torstatus.blutmagie.de/ip_list_all.php/Tor_ip_list_ALL.csv?r=24007)
zeus|Abuse.ch Zeus Tracker default blocklist including hijacked sites and web hosting providers|ipv4 hash:ip|263 unique IPs|30 mins |[src](https://zeustracker.abuse.ch/blocklist.php?download=ipblocklist&r=21427)
