...
dshield|DShield.org top 20 attacking networks|ipv4 hash:net|20|4 hours |[source](http://feeds.dshield.org/block.txt?r=1797)
emerging_block|EmergingThreats.net default blacklist (at the time of writing includes spamhaus DROP and dshield)|ipv4 hash:net|921|12 hours |[source](http://rules.emergingthreats.net/fwrules/emerging-Block-IPs.txt?r=6667)
