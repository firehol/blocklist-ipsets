...
blocklist_de|Blocklist.de IPs that have attacked their honeypots in the last 48 hours|ipv4 hash:ip|25954 unique IPs|30 mins |[src](http://lists.blocklist.de/lists/all.txt?r=14783)
...
bruteforceblocker|danger.rulez.sk IPs detected by bruteforceblocker (fail2ban alternative for SSH on OpenBSD)|ipv4 hash:ip|2694 unique IPs|3 hours |[src](http://danger.rulez.sk/projects/bruteforceblocker/blist.php?r=100)
ciarmy|CIArmy.com IPs with poor Rogue Packet score that have not yet been identified as malicious by the InfoSec community|ipv4 hash:ip|425 unique IPs|3 hours |[src](http://cinsscore.com/list/ci-badguys.txt?r=4137)
...
danmetor|dan.me.uk dynamic list of TOR exit points|ipv4 hash:ip|6378 unique IPs|30 mins |[src](https://www.dan.me.uk/torlist/?r=10820)
...
palevo|Abuse.ch Palevo worm includes IPs which are being used as botnet C&C for the Palevo crimeware|ipv4 hash:ip|13 unique IPs|30 mins |[src](https://palevotracker.abuse.ch/blocklists.php?download=ipblocklist&r=7637)
