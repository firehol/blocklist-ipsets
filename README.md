...
The following list was automatically generated on Sun May 17 16:40:24 UTC 2015.
...
blocklist_de|Blocklist.de IPs that have attacked their honeypots in the last 48 hours|ipv4 hash:ip|24709 unique IPs|updated every 30 mins  from [this link](http://lists.blocklist.de/lists/all.txt)
...
danmetor|dan.me.uk dynamic list of TOR exit points|ipv4 hash:ip|6521 unique IPs|updated every 30 mins  from [this link](https://www.dan.me.uk/torlist/)
...
stop_forum_spam_1h|StopForumSpam.com last 24 hours IPs used by forum spammers|ipv4 hash:ip|5613 unique IPs|updated every 1 hour  from [this link](http://www.stopforumspam.com/downloads/listed_ip_1.zip)
...
tor_servers|torstatus.blutmagie.de list of all TOR network servers|ipv4 hash:ip|6497 unique IPs|updated every 30 mins  from [this link](https://torstatus.blutmagie.de/ip_list_all.php/Tor_ip_list_ALL.csv)
